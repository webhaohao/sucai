...
<body class="text-center">
	...
	<form class="form-signin" autocomplete="off">
		...
		<input type="text" id="account" class="form-control" name="account" placeholder="会员账号" required autofocus style="border-bottom-left-radius: 0;border-bottom-right-radius: 0;">
